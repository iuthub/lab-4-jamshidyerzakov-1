...
<div id="listarea">
    <ul id="musiclist">
        ...
        foreach ($musicFiles as $music) {
            ...
            if ($musicSize > 1024 && $musicSize < 1024*1024){
                $musicSize = $musicSize / 1024;
                $sizeExtension = "kb";
            }
            if ($musicSize > (1024*1024)){
                $musicSize = (int) $musicSize / (1024*1024);
                $sizeExtension = "mb";
            }
        ?>
        <li class="mp3item"> <a href="<?= $music ?>"><?= $musicName ?> </a> <?= " (".(int)$musicSize ." ". $sizeExtension." )" ?> </li>
        <?php } ?>
